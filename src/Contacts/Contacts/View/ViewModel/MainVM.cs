...
public class MainVM : INotifyPropertyChanged
{
    ...
    /// </summary>
    /// <param name="parameter">Параметр команды.</param>
    /// <returns>Возвращает true, если контакт можно добавить; иначе false.</returns>
    ...
    /// </summary>
    /// <param name="parameter">Параметр команды.</param>
    /// <returns>Возвращает true, если контакт можно редактировать; иначе false.</returns>
    ...
    /// </summary>
    /// <param name="parameter">Параметр команды.</param>
    /// <returns>Возвращает true, если контакт можно удалить; иначе false.</returns>
    ...
    /// </summary>
    /// <param name="parameter">Параметр команды.</param>
    /// <returns>Возвращает true, если изменения можно применить; иначе false.</returns>
    ...
    /// Если есть, то кнопка Aply неактивна.
    /// </summary>
    /// <returns>
    /// Возвращает true, если у выбранного контакта есть ошибки валидации
    /// в полях "Name", "PhoneNumber" или "Email"; иначе false.
    /// </returns>
    private bool HasValidationErrors => SelectedContact != null &&
                            (!string.IsNullOrEmpty(SelectedContact[nameof(Contact.Name)]) ||
